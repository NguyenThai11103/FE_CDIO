                ...
                <div class="col mx-auto">
                    <div class="card">
                        ...
                        <form class="form">
                            ...
                            <input v-model="user.email" spellcheck="false" class="input" type="email" name="email"
                                id="email-input" />
                            ...
                            <input v-model="user.password" spellcheck="false" class="input" type="text" name="password"
                                id="password-input" />
                            <button v-on:click="dangNhap()" class="submit" type="button">Submit</button>
                        </form>
