...
<script>
import TopQuanAn from "../../components/QuanAn/TopQuanAn.vue";
import BotQuanAn from "../../components/QuanAn/BotQuanAn.vue";
import MenuQuanAn from "../../components/QuanAn/MenuQuanAn.vue";
...
import "../../../assets/assets_Rocker/js/pace.min.js";
export default {
    name        :   "app",
    components  :   {
...
@import "../../../assets/assets_Rocker/plugins/metismenu/css/metisMenu.min.css";
@import "../../../assets/assets_Rocker/css/pace.min.css";
